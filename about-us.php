                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="title1-wrapper text-center style2">
                                    <div class="title1-inner">
                                        ...
                                        <p itemprop="description"><p>The online food ordering system provides convenience for the customers. It overcomes the disadvantages of the traditional queuing system. This system increases the takeaway of foods than visitors. Therefore, this system enhances the speed and standardization of taking the order from the customer. It provides a better communication platform. the user’s details are noted electronically.</p></p>
                                    </div>
                                </div>
